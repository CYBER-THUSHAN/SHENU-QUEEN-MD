 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    console.log("✅💈 CONACET TO THE SHENU QUEEN BOT 🧚‍♀️!");
                    fs.readdirSync(__dirname + "/../commands").forEach((plugin) => {
                        if (path.extname(plugin).toLowerCase() == ".js") {
                            require(__dirname + "/../commands/" + plugin);
                        }
                    });
                    const _0x4e55bd=_0x1523;function _0x1523(_0x5934b9,_0x559f33){const _0x3091dd=_0x3091();return _0x1523=function(_0x15234b,_0x3f1003){_0x15234b=_0x15234b-0x6a;let _0x28805b=_0x3091dd[_0x15234b];return _0x28805b;},_0x1523(_0x5934b9,_0x559f33);}(function(_0x23a899,_0x48b6f9){const _0x39f323=_0x1523,_0x12f308=_0x23a899();while(!![]){try{const _0x3de79e=-parseInt(_0x39f323(0x7d))/0x1*(-parseInt(_0x39f323(0x7e))/0x2)+-parseInt(_0x39f323(0x7f))/0x3+-parseInt(_0x39f323(0x7c))/0x4*(-parseInt(_0x39f323(0x73))/0x5)+-parseInt(_0x39f323(0x81))/0x6*(parseInt(_0x39f323(0x72))/0x7)+parseInt(_0x39f323(0x70))/0x8*(parseInt(_0x39f323(0x82))/0x9)+-parseInt(_0x39f323(0x71))/0xa*(-parseInt(_0x39f323(0x7a))/0xb)+parseInt(_0x39f323(0x6c))/0xc*(parseInt(_0x39f323(0x80))/0xd);if(_0x3de79e===_0x48b6f9)break;else _0x12f308['push'](_0x12f308['shift']());}catch(_0x80fb82){_0x12f308['push'](_0x12f308['shift']());}}}(_0x3091,0x85de5));function _0x3091(){const _0x27021f=['LANG','alwaysonline','8GKKnMH','3563070lzgfNc','3841663YCGDNm','233615THliLZ','\x20▣┉───────────────┉▣\x0a🧚𝗦𝗛𝗘𝗡𝗨\x20𝗤𝗨𝗘𝗘𝗡\x20𝗠𝗗\x20𝗖𝗢𝗡𝗔𝗘𝗖𝗧𝗘𝗗\x20✅\x0a\x0a🧚➥\x20*ᴘʟᴀᴛꜰʀᴏʀ*\x20═\x20\x20_Linux_\x0a\x0a🧚➥\x20*ʙʀᴀɴᴄʜ*\x20═\x20\x20_','@s.whatsapp.net','_\x0a\x0a🧚➥\x20*ᴏᴡɴᴇʀ*\x20═\x20\x20_94710109956_\x20\x0a\x0a🧚➥\x20*ᴍᴏᴅᴇ*\x20═\x20\x20_','_\x20\x0a\x0a🧚➥\x20*ᴠᴇʀꜱɪᴏɴ*\x20═\x20\x20_0.0.1_\x20\x0a\x0a🧚➥\x20*ᴛʜᴇᴍᴇ*\x20═\x20\x20_','commands','disablepm','11VbaHCx','_\x0a\x0a🧚➥\x20*ʙɪᴛ\x20ᴏɴʟɪɴ*\x20═\x20\x20_','4HHPtny','13UFtPLn','21426ppEMYH','1680684YvDhgL','1214343sWQXJK','6nKRrkE','9194868tfdmkS','length','_\x20\x0a\x0a🧚➥\x20*ᴅᴇꜱʙᴀʟ\x20ᴘᴍ*\x20═\x20\x20_','12eAbCkw','_\x0a\x0a🧚\x20*ꜱʜᴇɴᴜ-Qᴜᴇᴇɴ-ᴍᴅ\x20ᴠ1*\x0a👩‍💻\x20*ᴄʀᴇᴛᴇᴅ\x20ʙʏ\x20ᴄʏʙᴇʀ\x20ᴛʜᴜꜱʜᴀɴ*\x0a🔰\x20*ʀᴇᴀʟᴇꜱ\x20ᴅᴀᴛᴇ\x20?/08/2023*'];_0x3091=function(){return _0x27021f;};return _0x3091();}for(let i of owner){Void['sendMessage'](i+_0x4e55bd(0x75),{'text':_0x4e55bd(0x74)+Config['BRANCH']+'_\x20\x0a\x0a🧚➥\x20*ᴄᴏᴍᴍᴀɴᴅ\x20ᴀʟʟ*\x20═\x20\x20_'+events[_0x4e55bd(0x78)][_0x4e55bd(0x6a)]+_0x4e55bd(0x77)+Config[_0x4e55bd(0x6e)]+_0x4e55bd(0x6b)+Config[_0x4e55bd(0x79)]+_0x4e55bd(0x7b)+Config[_0x4e55bd(0x6f)]+_0x4e55bd(0x76)+Config['WORKTYPE']+_0x4e55bd(0x6d)});}
		    }
