...
if (fs.existsSync('./lib/Nero/' + Config.LANG + '.json')) {	
	//log(pint('Loading ' + Config.LANG + ' language...', '.'));	
	var json = JSON.parse(fs.readFileSync('./lib/Nero/' + Config.LANG + '.json'));	
} else {	
	var json = JSON.parse(fs.readFileSync('./lib/Nero/Dark-Nero.json'));	
}	
