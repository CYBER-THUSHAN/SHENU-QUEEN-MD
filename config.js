...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("254114763916,")
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://tonje:tonje@atlascluster.r14otla.mongodb.net/?retryWrites=true&w=majority"
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'TONJE 🐺-MD 🧚' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Alien Tonje' : process.env.OWNER_NAME,
  ownernumber: process.env.OWNER_NUMBER === undefined ? '254114763916' : process.env.OWNER_NUMBER,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_INFO.split(";")[0] === undefined ? '🚨🧚‍♀️Alien Tonje' : process.env.PACK_INFO.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS === undefined ? true : process.env.AUTO_READ_STATUS,
  packname:  process.env.PACK_INFO.split(";")[1] === undefined ? 'Tonje  𝗠𝗗' : process.env.PACK_INFO.split(";")[1],	
